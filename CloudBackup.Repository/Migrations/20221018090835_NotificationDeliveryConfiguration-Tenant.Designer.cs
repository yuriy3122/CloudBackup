...
namespace CloudBackup.Repository.Migrations
{
    ...
    [Migration("20221018090835_NotificationDeliveryConfiguration-Tenant")]
    partial class NotificationDeliveryConfigurationTenant
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloudBackup.Model.Alert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CloudBackup.Model.NotificationConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IncludeTenants")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<int?>("NotificationDeliveryConfigurationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NotificationDeliveryConfigurationId");
            ...
            modelBuilder.Entity("CloudBackup.Model.NotificationDeliveryConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NotificationDeliveryConfigurations");
                });
            ...
            modelBuilder.Entity("CloudBackup.Model.UserAlert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CloudBackup.Model.Alert", b =>
                {
                    b.HasOne("CloudBackup.Model.Log", "Log")
                        .WithMany()
                        .HasForeignKey("LogId");
            ...
            modelBuilder.Entity("CloudBackup.Model.NotificationConfiguration", b =>
                {
                    b.HasOne("CloudBackup.Model.NotificationDeliveryConfiguration", "NotificationDeliveryConfiguration")
                        .WithMany()
                        .HasForeignKey("NotificationDeliveryConfigurationId");
                    ...
                    b.Navigation("NotificationDeliveryConfiguration");
            ...
            modelBuilder.Entity("CloudBackup.Model.UserAlert", b =>
                {
                    b.HasOne("CloudBackup.Model.Alert", "Alert")
                        .WithMany("UserAlerts")
